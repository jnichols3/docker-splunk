...
# Install busybox
# arch as used in the other base images does not work very well on arm here since busy box uses the armvX scheme
wget -O /bin/busybox https://busybox.net/downloads/binaries/1.28.1-defconfig-multiarch/busybox-armv8l
chmod +x /bin/busybox
